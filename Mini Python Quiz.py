...
def simula():
    ...
    print(tanong[0])
    sagot1 = str(input('Enter your answer: '))
...
def resulta1():
    ...
    if result == 'v' or result == 'V':
     ...
     if score == 0 or score == 1 or score == 2:
        ...
        print("          Computer: GOOD JOB YOU PASSED THE PAGSUSULIT")
     elif score == 5:
        print("          Computer: WOW YOU DID GREAT! YOU'RE GOING TO BE A GREAT PROGRAMMER IN THE FUTURE!")
